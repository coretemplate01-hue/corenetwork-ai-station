...
-- Drop the existing overly permissive policies with correct names
DROP POLICY IF EXISTS "Authenticated users can view presentation history" ON public.presentation_history;
DROP POLICY IF EXISTS "Authenticated users can create presentation history" ON public.presentation_history;
